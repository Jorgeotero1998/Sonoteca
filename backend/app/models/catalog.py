...
class CatalogItem(Base):
    ...
    __table_args__ = (
        UniqueConstraint("provider", "provider_id", "type", name="uq_catalog_item_ref"),
    )
...
class UserFavorite(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "provider", "provider_id", "type", name="uq_user_fav_ref"),
    )
...
class UserLibrary(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "provider", "provider_id", "type", name="uq_user_lib_ref"),
    )
